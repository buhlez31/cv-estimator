...
_RULES: list[tuple[int, tuple[str, ...], str]] = [
    ...
    (85,  ("network engineer", "network administrator", "devops engineer", "platform engineer"), "2523"),
    ...
    (70,  ("backend", "back-end", "back end", "software engineer", "software developer", "developer", "programmer", "engineer"), "2512"),
